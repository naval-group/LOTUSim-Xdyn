...
`diffraction_module_tables` | Module des efforts de diffraction, par pulsation omega et par incidence psi (M[omega][psi]) | `[DIFFRACTION_FORCES_AND_MOMENTS]/[INCIDENCE_EFM_MOD_i]` | Colonne de gauche de `F_dif_m`
`diffraction_phase_tables` | Phase des efforts de diffraction, par pulsation omega et par incidence psi (M[omega][psi]) | `[DIFFRACTION_FORCES_AND_MOMENTS]/[INCIDENCE_EFM_PH_i]` | Colonne de droite de `F_dif_m`
...
`froude_krylov_module_tables` | Module des efforts de Froude-Krylov, par pulsation omega et par incidence psi (M[omega][psi]) | `[FROUDE-KRYLOV_FORCES_AND_MOMENTS]/[INCIDENCE_FKFM_MOD_i]` | Colonne de gauche des signaux `F_in_mi` où i désigne le degré de liberté, de 1 à 6
