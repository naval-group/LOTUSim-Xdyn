...
`diffraction_module_tables` | Module des efforts de diffraction, par pulsation et par incidence | `[DIFFRACTION_FORCES_AND_MOMENTS]/[INCIDENCE_EFM_MOD_i]` | Colonne de gauche de `F_dif_m`
`diffraction_phase_tables` | Phase des efforts de diffraction, par pulsation et par incidence | `[DIFFRACTION_FORCES_AND_MOMENTS]/[INCIDENCE_EFM_PH_i]` | Colonne de droite de `F_dif_m`
`diffraction_module_periods` | Périodes auxquelles sont définis les modules des efforts de diffraction | Première colonne de `[DIFFRACTION_FORCES_AND_MOMENTS]/[INCIDENCE_EFM_MOD_i]` | `Dimensions/waveFreq/wave frequencies`
`diffraction_phase_periods` | Périodes auxquelles sont définies les phases des efforts de diffraction | Première colonne de `[DIFFRACTION_FORCES_AND_MOMENTS]/[INCIDENCE_EFM_PH_i]` | `Dimensions/waveFreq/wave frequencies`
`diffraction_module_psis` | Incidences auxquelles sont définis les modules des efforts de diffraction | `[DIFFRACTION_FORCES_AND_MOMENTS]/[INCIDENCE_EFM_MOD_i]` | `Dimensions/waveDir/wave directions`
`diffraction_phase_psis` | Incidences auxquelles sont définies les phases des efforts de diffraction | `[DIFFRACTION_FORCES_AND_MOMENTS]/[INCIDENCE_EFM_PH_i]` | `Dimensions/waveDir/wave directions`
`froude_krylov_module_tables` | Module des efforts de Froude-Krylov, par pulsation et incidence | `[FROUDE-KRYLOV_FORCES_AND_MOMENTS]/[INCIDENCE_FKFM_MOD_i]` | Colonne de gauche des signaux `F_in_mi` où i désigne le degré de liberté, de 1 à 6
`froude_krylov_phase_tables` | Phase des efforts de Froude-Krylov, par pulsation et incidence | `[FROUDE-KRYLOV_FORCES_AND_MOMENTS]/[INCIDENCE_FKFM_PH_i]` | Colonne de droite des signaux `F_inc_mi` où i désigne le degré de liberté, de 1 à 6
`froude_krylov_module_periods` | Périodes auxquelles sont définis les modules des efforts de Froude-Krylov | Première colonne de chaque ligne de `[FROUDE-KRYLOV_FORCES_AND_MOMENTS]/[INCIDENCE_FKFM_MOD_i]` | `Dimensions/waveFreq/wave frequencies`
`froude_krylov_phase_periods` | Périodes auxquelles sont définies les phases des efforts de Froude-Krylov | Première colonne de chaque ligne de `[FROUDE-KRYLOV_FORCES_AND_MOMENTS]/[INCIDENCE_FKFM_PH_i]` | `Dimensions/waveFreq/wave frequencies`
`froude_krylov_module_psis` | Incidences auxquelles sont définis les modules des efforts de Froude-Krylov | `[FROUDE-KRYLOV_FORCES_AND_MOMENTS]/[INCIDENCE_FKFM_MOD_i]` | `Dimensions/waveDir/wave directions`
`froude_krylov_phase_psis` | Incidences auxquelles sont définies les phases des efforts de Froude-Krylov | `[FROUDE-KRYLOV_FORCES_AND_MOMENTS]/[INCIDENCE_FKFM_PH_i]` | `Dimensions/waveDir/wave directions`
`angular_frequencies` | Pulsations auxquelles sont définis les coefficients de la matrice de masses ajoutées et les coefficients d'amortissement de radiation | Première colonne de `[Added_mass_Radiation_Damping]/[ADDED_MASS_LINE_i]` | `Dimensions/waveFreq/wave frequencies`
