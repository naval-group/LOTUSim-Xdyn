...
Il est important de noter que les dérivées des angles d'Euler sont calculées selon la convention d'angles `z, y', x''` (`id = 12` dans le tableau des conventions). Les autres conventions ne sont pas supportées pour le moment.
