 ...
 *  \ingroup wave_models
 *  \section ex1 Example
 *  \snippet environment_models/unit_tests/PiersonMoskowitzSpectrum : public WaveSpectrumTest.cpp PiersonMoskowitzSpectrum : public WaveSpectrumTest example
 *  \section ex2 Expected output
 *  \snippet environment_models/unit_tests/PiersonMoskowitzSpectrum : public WaveSpectrumTest.cpp PiersonMoskowitzSpectrum : public WaveSpectrumTest expected output
