 ...
 *  \ingroup wave_models
 *  \section ex1 Example
 *  \snippet environment_models/unit_tests/JonswapSpectrum : public WaveSpectrumTest.cpp JonswapSpectrum : public WaveSpectrumTest example
 *  \section ex2 Expected output
 *  \snippet environment_models/unit_tests/JonswapSpectrum : public WaveSpectrumTest.cpp JonswapSpectrum : public WaveSpectrumTest expected output
...
class JonswapSpectrum : public WaveSpectralDensity
{
    public:
        ...
        /**  \author cady
          ...
          *  \snippet environment_models/unit_tests/JonswapSpectrumTest.cpp JonswaSpectrumTest example
          */
