 ...
 *  \ingroup wave_models
 *  \section ex1 Example
 *  \snippet environment_models/unit_tests/WaveSpectrumTest.cpp WaveSpectrumTest example
 *  \section ex2 Expected output
 *  \snippet environment_models/unit_tests/WaveSpectrumTest.cpp WaveSpectrumTest expected output
 */
class WaveSpectralDensity
{
    public:
        ...
        /**  \brief Computes the amplitude of the power spectrum at a given angular frequency
          ...
          *  \snippet environment_models/unit_tests/WaveSpectrumTest.cpp WaveSpectrumTest get_example
          */
        ...
        /**  \brief Compute wave number, in infinite depth.
          ...
          *  \snippet environment_models/unit_tests/WaveSpectralDensityTest.cpp WaveSpectralDensityTest get_wave_number_example
