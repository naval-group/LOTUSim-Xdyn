 ...
 *  \ingroup wave_models
 *  \section ex1 Example
 *  \snippet environment_models/unit_tests/BretschneiderSpectrumTest.cpp BretschneiderSpectrumTest example
 *  \section ex2 Expected output
 *  \snippet environment_models/unit_tests/BretschneiderSpectrumTest.cpp BretschneiderSpectrumTest expected output
 */
