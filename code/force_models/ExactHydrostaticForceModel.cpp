...
ExactHydrostaticForceModel::ExactHydrostaticForceModel(const std::string& body_name_, const EnvironmentAndFrames& env) :
        FastHydrostaticForceModel(ExactHydrostaticForceModel::model_name(), body_name_, env)
{
