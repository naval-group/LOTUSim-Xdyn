...
class ForceTests : public ::testing::Test
{
    protected:
        ...
        EnvironmentAndFrames get_env(const YamlModel& waves) const;
        DiffractionForceModel get_diffraction_force_model(const EnvironmentAndFrames& env, const std::string& diffraction_yaml, const std::string& hdb_file_contents) const;
