...
class WaveModelBuilderInterface
{
    public:
        ...
        virtual boost::optional<TR1(shared_ptr)<WaveModel> > try_to_parse(const std::string& model, const FlatDiscreteDirectionalWaveSpectrum& spectrum, const std::string& yaml) const = 0;
...
template <typename T> class WaveModelBuilder : public WaveModelBuilderInterface
{
    public:
        ...
        boost::optional<TR1(shared_ptr)<WaveModel> > try_to_parse(const std::string& model, const FlatDiscreteDirectionalWaveSpectrum& spectrum, const std::string& yaml) const;
};
